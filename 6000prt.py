...
tasks = {
    b'Beautiful is better than?' : b'No books here, damnnit!.',
    b'Explicit is better than?' : b'No books here, damnnit!.',
    b'What session?' : b'No books here, damnnit!.',
}
...
def parse_cmd_line(desc):
    ...
    parser.add_argument('-p', metavar='port', type=int, default=6000, help='TCP port')
